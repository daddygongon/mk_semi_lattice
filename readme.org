...
* Usage
hcは単語カードをpcで実装したアプリです．
Thor(git風)を使っているので，subcommandにhelpをつければ
そこで用意されているoptionsが表示されます．
help(-h)にしたがって操作すれば大体使えることを期待しています．
...
- [[./lib/plot/docs/readme.org][hc plot]]            # plot logs
